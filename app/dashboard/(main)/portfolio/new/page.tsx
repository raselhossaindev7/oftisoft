...
import { Plus, ArrowLeft, Upload, Loader2, Tag } from "lucide-react";
        ...
        <div className="space-y-8">
            ...
            <Card className="border-border/50 max-w-3xl">
                <CardHeader>
                    ...
                    <CardDescription>Fill in the details for the new portfolio item</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <Input placeholder="Project Name" className="rounded-lg h-9" value={formData.title}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input placeholder="Web App, Mobile, Design" className="rounded-lg h-9" value={formData.category}
                                    onChange={(e) => setFormData(p => ({ ...p, category: e.target.value }))} />
                            </div>
                            <div className="space-y-1.5">
                                <Label className="text-xs font-medium">Client <span className="text-destructive">*</span></Label>
                                <Input placeholder="Client Name" className="rounded-lg h-9" value={formData.client}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Textarea placeholder="Brief project description..." className="rounded-lg min-h-[80px] resize-none"
                                value={formData.description}
                                onChange={(e) => setFormData(p => ({ ...p, description: e.target.value }))} />
                        </div>
                        <div className="space-y-1.5">
                            <Label className="text-xs font-medium">Long Description</Label>
                            <Textarea placeholder="Detailed project description..." className="rounded-lg min-h-[120px] resize-none"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <Input placeholder="react, typescript" className="rounded-lg h-9 pl-10" value={formData.tags}
                                        onChange={(e) => setFormData(p => ({ ...p, tags: e.target.value }))} />
                                </div>
                            </div>
                            <div className="space-y-1.5">
                                <Label className="text-xs font-medium">Demo URL</Label>
                                <Input placeholder="https://..." className="rounded-lg h-9"
