          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{summary?.totalDownloads || 0}</div>
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{summary?.uniqueProducts || 0}</div>
                        ...
                        <div key={d.date} className="flex items-center gap-4">
                          ...
                          <div className="flex-1 h-6 bg-muted/30 rounded-lg overflow-hidden">
                            <div
                              ...
                              style={{ width: `${Math.min((d.count / Math.max(...byDay.map((x: any) => x.count))) * 100, 100)}%` }}
                            />
                          </div>
